...
- Maîtrise des enjeux réglementaires (PAC, environnement)
- Expérience terrain : contrôles et expérimentation variétale

### 📊 Analyse & données
- Analyse de données agricoles et commerciales (Excel, reporting)
- Suivi de performance (KPI, ventes, portefeuille agriculteurs)
...
- 📊 Approche orientée décision et performance
...
### 🌾 Instructeur & Contrôleur PAC – DDT 31 (2025)
- Instruction de dossiers surfaces via QGIS
